# **Beschreibung und Gebrauchshinweise für den Internet Creator v0.12.3**
...
**(12)** Wenn man auf gewohnte Weise eine vyos.qcow2 aus dem Stream-Release zu erstellen versucht - und zwar egal, ob mit der md5 oder der sha256 Verifikation:
```Bash
